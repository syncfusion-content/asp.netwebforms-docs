...
2. After completing the required form or logging in with your registered Syncfusion account, you can download the ASP.NET Web Forms trial installer from the confirmation page. (See the screenshot below.) 
...
7. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio ASP.NET Web Forms Offline trial installer which is available in EXE and ZIP format.
...
You can also refer to the [**Online installer**](https://help.syncfusion.com/aspnet/installation-and-upgrade/install-using-the-web-installer) and [**Offline installer**](https://help.syncfusion.com/aspnet/installation-and-upgrade/install-using-the-offline-installer) links for step-by-step installation guidelines.	