...
* \#143484- Support for WordWrap in PDF Exporting is provided.

* \#142605- ~addParams is now working when the ~WebMethodAdaptor is used.

* \#142399- Support for ~RTL language during PDF ~Exporting is provided.

* \#142362- Grid Model is now updated after filtering in the ASP.NET.

* \#141236- Occurrence of the script error when using the ~TemplateID in ~CustomToolbarItem and while triggering the server side events is resolved.
