---
layout: post
title: Pages | PDF | ASP.NET | Syncfusion
description: pages
platform: aspnet
control: pdf
documentation: ug
...
N> To import the document asynchronously for Windows Store apps, refer the_ [Asynchronous Support](http://help.syncfusion.com/file-formats/PDF/Getting-Started) _section.
