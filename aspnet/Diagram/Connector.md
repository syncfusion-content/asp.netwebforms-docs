...
{% highlight c# %}
  ...
  //for node creation refer to the link [Node creation](http://help.syncfusion.com/aspnetmvc/diagram/getting-started#create-your-first-diagram-in-mvc)
...
For creating specific port connection, refer to the link [Port to Port Connection.](http://help.syncfusion.com/js)
...
N> Connector’s constraints property is manipulated by using bitwise operations. For more information about bitwise operations, see [Bitwise Operations](http://help.syncfusion.com/aspnet/diagram/how-to/bitwise-operations)
