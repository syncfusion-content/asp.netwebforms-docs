...
You can create a WEB Project and add necessary Dll and script with the help of the given [ASP-Getting Started Documentation.](http://docs.syncfusion.com/aspnet/captcha/getting-started)
