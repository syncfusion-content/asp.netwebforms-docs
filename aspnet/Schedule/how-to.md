...
<asp:Content ID="ScriptContent" runat="server" ContentPlaceHolderID="ScriptSection">
    <script type="text/javascript">
        ...
        function onCreate(args) {
            var customDesign = "<tr class='custom-fields'><td class='e-text-label'>Event Type</td><td><input class='app-type' type='text'/></td><td class='e-text-label'>Event Status </td><td><input class='status' type='text'/></td></tr>";
