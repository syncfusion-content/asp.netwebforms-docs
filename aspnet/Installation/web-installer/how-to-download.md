---
layout: post
title: Downloading Syncfusion ASP.NET web installer - Syncfusion
description: Learn here about the how to download Syncfusion ASP.NET web installer from our syncfusion website with license.
platform: aspnet
...
# Downloading Syncfusion ASP.NET Web Forms web installer
...
8. After downloading, the Syncfusion ASP.NET web installer can be unlocked using Syncfusion registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/aspnet/installation/install-using-the-web-installer) links for step-by-step installation guidelines.	