---
layout: post
title: Installing Syncfusion ASP.NET web installer - Syncfusion
description: Learn here about how to install Syncfusion ASP.NET web installer after downloading from our Syncfusion website.
platform: aspnet
...
# Installing Syncfusion ASP.NET Web Forms web installer
...
7.  The Configuration Wizard will appear. You can change the Download, Install, and Demos locations from here. You can also change the Additional settings on a product-by-product basis. Click Next to install with the default settings.
    ...
    ![Install and samples location for install](images/Step-by-Step-Installation_img23.png)
...
1.  The Syncfusion ASP.NET Web Forms Web Installer's welcome wizard will be displayed. Click the Next button
