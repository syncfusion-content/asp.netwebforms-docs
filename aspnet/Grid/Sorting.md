---
layout: post
title: Sorting | ASP.NET | Grid widget | Syncfusion 
description: Learn here about how to enable sorting and its functionalities in Syncfusion Essential ASP.NET Grid Control, its elements, and more.
platform: aspnet
control: Grid
documentation: ug
---
# Sorting in ASP.NET Grid
...
![Sorting in ASP.NET Grid](Sorting_images/Sorting_img1.png)
...
![Initial Sorting in ASP.NET Grid](Sorting_images/Sorting_img2.png)
...
![Multi-Column Sorting in ASP.NET Grid](Sorting_images/Sorting_img3.png)
...
![Stable Sorting in ASP.NET Grid](Sorting_images/Sorting_img4.png)
...
![Touch options in ASP.NET Grid](Sorting_images/Sorting_img5.png)
