---
layout: post
title: Filtering in ASP.NET Grid widget | Syncfusion
description: Learn here about how to enable filtering and its functionalities in Syncfusion Essential ASP.NET Grid Control, its elements, and more.
platform: aspnet
control: Grid
documentation: ug
---
# Filtering in ASP.NET Grid widget
...
![Filtering in ASP.NET Grid widget](Filtering_images/Filtering_img1.png)
...
![Menu Filter in ASP.NET Grid widget](Filtering_images/Filtering_img2.png)

Numeric Filter

![Numeric Filter in ASP.NET Grid widget](Filtering_images/Filtering_img3.png)

String Filter

![String Filter in ASP.NET Grid widget](Filtering_images/Filtering_img4.png)

Date Filter

![Date Filter in ASP.NET Grid widget](Filtering_images/Filtering_img5.png)
...
![Excel like filter in ASP.NET Grid widget](Filtering_images/Filtering_img6.png)
...
![Checkbox list in ASP.NET Grid widget](Filtering_images/filtering_img7.png)
...
![Selection in ASP.NET Grid widget](filtering_images/filtering_img12.png)
...
![Case sensitivity in ASP.NET Grid widget](Filtering_images/filtering_img8.png)
...
![Filter bar in ASP.NET Grid widget](Filtering_images/filtering_img9.png)
...
![Filter bar modes in ASP.NET Grid widget](Filtering_images/filtering_img10.png)
...
![Filterbar template in ASP.NET Grid widget](filtering_images/filtering_img11.png)
{:caption}
After Filtering
