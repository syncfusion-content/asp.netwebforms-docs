...
description: Learn here more about getting started with Syncfusion ASP.NET UploadBox Control, its elements, and more.
platform: aspnet
control: UploadBox
documentation: ug
---
...
![Create your first UploadBox in ASP.NET](Getting-Started_images/Getting-Started_img1.png)
...
![Code hundlers in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img3.png)

Run the project to see the following output for the given steps. The file is uploaded. 

![Project handlers in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img4.png)
