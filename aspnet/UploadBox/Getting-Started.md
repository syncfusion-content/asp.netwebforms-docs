...
description: Learn here more about getting started with Syncfusion Essential ASP.NET UploadBox Control, its elements, and more.
platform: aspnet
control: UploadBox
documentation: ug
---

# Getting Started with ASP.NET UploadBox
...
![Getting Started with ASP.NET UploadBox](Getting-Started_images/Getting-Started_img1.png)
...
![Create UploadBox widgets in ASP.NET](Getting-Started_images/Getting-Started_img2.png)
...
![Code example in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img3.png)

Run the project to see the following output for the given steps. The file is uploaded. 

![Project in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img4.png)
...
![Set Restrictions to File Extensions in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img5.png)
...
![Upload Multiple Files in ASP.NET UploadBox](Getting-Started_images/Getting-Started_img6.png)