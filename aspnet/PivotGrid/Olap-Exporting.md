...
When PivotGrid is rendered, a server side event needs to be added in code behind file of the application and we need to import **"Syncfusion.EJ.Export"** namespace in the code behind file. 
...
Following server side event method needs to be added in code behind file of the application.
