...
description: Learn here about integration with other controls in Syncfusion ASP.NET Tab control, its elements and more.
platform: aspnet
control: Tab
documentation: ug
---

#  Integration with other controls in ASP.NET Tab
...
<https://help.syncfusion.com/aspnet/rating/overview>
