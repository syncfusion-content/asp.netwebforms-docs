...
N> In case the second DropDown is disabled, until the first one is selected, you need to set enable property to false in a second DropDown that enables automatically once the value is selected in a first one. 
